    ...
    for j in range(entries):
        ...
        if not entry:
            ...
            if table.upper() == "PATIENT":
                ...
                Gender, Address, Phone, Insurance_ID, Admission_Date) 
                ...
                if patient_room != 0:
                    cursor.execute(f"INSERT INTO diagnosis(Diagnosis, Room_Number, Treated_By) VALUES {patient_diagnosis, patient_room, treated_by}")
                    ...
                    cursor.execute(f"INSERT INTO diagnosis(Diagnosis, Room_Number, Treated_By) VALUES (%s, %s, %s)", data)
