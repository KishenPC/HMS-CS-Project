    ...
    for j in range(entries):
        ...
        if not entry:
            ...
            if table.upper() == "PATIENT":
                ...
                print(DoBFormat[0],DoBFormat[1],DoBFormat[2])
                ...
                cursor.execute("""UPDATE patient
                            ...
                            WHERE Insurance_ID=''""") #Done to add null in empty slots
                ...
                if patient_room != 0:
                    ...
                    cursor.execute("""UPDATE diagnosis
                            SET Treated_By=NULL
                            WHERE Treated_By=''""") #Done to add null in empty slots
...
def show_table():
    ...
    if len(item)==0:
        ...
        if s_table.upper()=="PATIENT":
            ...
            diag_header=["Patient ID", "Patient Diagnosis", "Room Number", "Treated_By"]
...
print("  [Credits] Abin Krishna, Kishen PC, Vaishak Nambiar")
print("="*81+"""
...
""")
            ...
            elif action.upper() in ["COLOUR 1", "COLOR 1", "1"]:
                os.system("color 3")
            elif action.upper() in ["COLOUR 2", "COLOR 2", "2"]:
                os.system("color 5")
            elif action.upper() in ["COLOUR 3", "COLOR 3", "3"]:
                os.system("color 1")
            elif action.upper() in ["COLOUR 4", "COLOR 4", "4"]:
                os.system("color 2")
            elif action.upper() in ["COLOUR 5", "COLOR 5", "5"]:
                os.system("color 7")
